...
const defaultMessages: Record<Locale, Messages> = {
  en: {
    common: {
      ...
      brandSlogan: 'Professional JFIF to JPG converter, supports batch conversion, quality adjustment, and size adjustment',
  ...
  'zh-CN': {
    common: {
      ...
      brandSlogan: '专业的在线JFIF转JPG转换工具，支持批量转换、质量调节、尺寸调整',
      applyAll: '应用到全部',
      applyToAll: '应用到所有文件',
      reset: '重置',
      resetOptions: '重置选项',
